...
timeline_data <- combined_df %>%
  select(ttas_id, date, basmi_score, basdai, basfi, patient_global, back_pain_at_night, back_pain_anytime, corrected_asqol, corrected_facit, corrected_jenkins_sleep_scale, presentism, absentism, wpl, daily_activity_impairment, margolis) %>%
  # select(ttas_id, date, basmi_score, basdai, basfi, as_qol) %>%
  # pivot_longer(cols = c(basmi_score, basdai, basfi, as_qol),
  pivot_longer(cols = c(basmi_score, basdai, basfi, patient_global, back_pain_at_night, back_pain_anytime, corrected_asqol, corrected_facit, corrected_jenkins_sleep_scale, presentism, absentism, wpl, daily_activity_impairment, margolis),
               names_to = "Measure",
               values_to = "Score")
