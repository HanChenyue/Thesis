...
```{r}
model_11 <- lmer(basmi_score ~ gender + hlab27status + age_at_basmi + diagnosis + treatment_reclassified*diagnosis + time_in_weeks + (time_in_weeks | ttas_id), data = dataframe_sorted_and_reclassified)
